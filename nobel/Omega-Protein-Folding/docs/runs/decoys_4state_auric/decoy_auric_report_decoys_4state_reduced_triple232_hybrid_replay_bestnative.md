# Auric decoy benchmark (decoys_4state_reduced_triple232_hybrid_replay_bestnative)
...
- Targets used: 7
- Samples CSV (gitignored): `data/processed/decoy_bench/auric_decoys_samples_decoys_4state_reduced_triple232_hybrid_replay_bestnative.csv`
- Summary CSV (gitignored): `data/processed/decoy_bench/auric_decoys_summary_decoys_4state_reduced_triple232_hybrid_replay_bestnative.csv`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1ctf | 630 (failQC=1) | 0.365 | -0.273 | 0.457 | -0.087 | 0.710 | 0.727 | 0.365 |
...
| 4pti | 686 (failQC=1) | 0.032 | -0.968 | 0.052 | -0.948 | 0.351 | 0.499 | 0.032 |
| 4rxn | 677 (failQC=0) | 0.171 | -0.663 | 0.258 | -0.487 | 0.619 | 0.109 | 0.171 |

- Fraction targets with native in lowest 10% of decoys (rhoA type_entropy, m=8): 0.429
- Fraction targets with native in lowest 10% of decoys (rhoB=parity type_entropy, m=8): 0.000
- Fraction targets with native in lowest 10% of decoys (rhoB=vel type_entropy, m=8): 0.143
- Fraction targets with native in lowest 10% by min(A,Bparity) (type_entropy, m=8): 0.429
