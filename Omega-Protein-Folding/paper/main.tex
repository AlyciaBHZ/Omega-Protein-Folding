...
% Content lives in paper/sections/*.tex and is kept in sync with:
% - docs/manuscript/Omega_v1_NatureStyle_EN_v1p2.md
% - paper/source/Omega_v1_NatureStyle_EN_v1p2.tex
%
