...
\paragraph{(ii) Frustration-guided nonlocal moves.}
We curate a bank of nonlocal basin-hopping moves and apply them adaptively based on a frustration/roughness proxy derived from observed residual geometry (not a physical energy, but an audit-fixed scalar field).
